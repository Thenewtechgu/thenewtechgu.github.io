...
// }
let toeicImages = `AtBreathtaking
BookshelfLibrary
BreakfastToast
BroomAutumn
CashierItems
...
function MakeTOEICQuestion(task, result) {
    let question = toeicImages[Math.floor(toeicImages.length * (Math.random() * 0.99))];
...
const MakeWT = (contest = 'IELTS', wanted = 'foo', id = '', prefix = '', time = 9999) => {
    cdate = 0;
